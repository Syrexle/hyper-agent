...
class Settings(BaseSettings):
    ...
    trailing_start_pct: Decimal = Field(default=Decimal("3"), alias="TRAILING_START_PCT")
    trailing_distance_pct: Decimal = Field(default=Decimal("2"), alias="TRAILING_DISTANCE_PCT")
